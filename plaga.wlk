...
object nivelMinimoDeProduccion {
  var property valor = 2000                  // Pacial!!! referencia a un objeto externo 
}
...
class Barrio {
  ...
  method elementosBuenos() = elementos.count({e=>e.esBUenos()})
   method elementosNoBuenos() = elementos.count({e=>!e.esBUenos()})
}
